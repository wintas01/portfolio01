        ...
        >
          <div className="lg:col-span-5 order-2 lg:order-1">
            <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-muted max-w-sm mx-auto lg:max-w-none">
              <img src={aboutPhoto} alt="Wintas" className="w-full h-full object-cover object-top" />
            </div>
          </div>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex flex-col gap-5">
            ...
            >
              ...
              <div>
                <p className="text-xs text-muted-foreground mb-0.5 uppercase tracking-wider font-medium">WhatsApp</p>
                <p className="text-base sm:text-lg font-semibold group-hover:text-muted-foreground transition-colors">+234 708 306 6127</p>
              </div>
            </a>
          </motion.div>
        </motion.div>
