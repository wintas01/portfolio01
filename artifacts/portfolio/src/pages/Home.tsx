...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-foreground selection:text-background font-sans overflow-x-hidden">
      ...
      <section
        id="home"
        className="pt-28 sm:pt-32 pb-16 px-5 sm:px-8 max-w-[1400px] mx-auto"
      >
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-8 items-center">
          ...
          >
            ...
            >
              From web applications and AI integrations to networking projects,
              I transform ideas into practical, user-focused digital products.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            >
              <div>
                ...
                <p className="text-xs sm:text-sm text-background/70 leading-tight">
      ...
      <section
        id="about"
        className="py-20 sm:py-32 px-5 sm:px-8 max-w-[1400px] mx-auto"
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 flex flex-col gap-6 sm:gap-8">
            ...
            >
              I'm constantly learning, experimenting, and building projects that
              challenge my skills and contribute to my growth as a software
              engineer. My goal is to create technology that is not only
              visually appealing but also meaningful and impactful.
            </motion.p>

            <motion.div
              variants={fadeInUp}
              className="grid sm:grid-cols-2 gap-6 sm:gap-8 pt-6 sm:pt-8"
            >
              <div>
                <h3 className="font-semibold text-base sm:text-lg mb-3 border-b border-border pb-2">
                  Expertise
                </h3>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-base sm:text-lg">
              Things I've built and places you can find my work.
            </p>
          </motion.div>
      ...
      >
        ...
        >
          <motion.h2
            variants={fadeInUp}
            className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-none mb-5 sm:mb-6"
          >
            Let's create <br />
          ...
          <motion.p
            variants={fadeInUp}
            className="text-base sm:text-xl text-muted-foreground mb-10 sm:mb-12"
          >
            Available for freelance and collaboration. Reach out and let's build
            something great.
          </motion.p>
          ...
          <motion.div variants={fadeInUp} className="flex flex-col gap-5">
            ...
            {/* WhatsApp */}
            <a
              href="https://wa.me/2347083066127"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 group w-fit"
            >
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-card border border-border flex items-center justify-center group-hover:bg-[#25D366] group-hover:text-white transition-colors flex-shrink-0">
                <svg
                  viewBox="0 0 24 24"
                  className="w-5 h-5 sm:w-6 sm:h-6 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
